      ...
      {listing.featured && (
        ...
        <div className='p-5 pt-8'>
            ...
            <div className='flex items-center justify-between'>
                ...
                <button onClick={()=> {navigate(`/listing/${listing.id}`); scrollTo(0,0)}} className='cursor-pointer px-7 py-3 bg-indigo-600 text-white text-sm rounded-lg hover:bg-indigo-700 transition'>
                    More Details
                </button>
            </div>
        </div>
