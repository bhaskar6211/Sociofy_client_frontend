      ...
      <footer className="mt-32 px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    <div className="sm:col-span-2 lg:col-span-1">
                        ...
                        <p className="text-sm/7 mt-6">Sociofy is a leading social media marketplace that connects brands with their customers through a seamless and user-friendly platform.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-6 max-w-sm">
                            ...
                            <div className="flex items-center justify-center gap-2 p-2 rounded-md bg-indigo-50">
                                ...
                                <button className="bg-indigo-600 px-4 py-2 text-white rounded cursor-pointer">Subscribe</button>
                            </div>
                        </div>
                    </div>
                </div>
                <p className="py-4 text-center border-t mt-6 border-slate-200">
                    Copyright 2025 © Sociofy All Right Reserved.
                </p>
        </footer>
    </>
  )
